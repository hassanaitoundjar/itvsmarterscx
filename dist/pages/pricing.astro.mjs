import { c as createComponent, r as renderComponent, a as renderTemplate } from '../chunks/astro/server_CwCVLbYD.mjs';
import 'kleur/colors';
import { $ as $$PageLayout } from '../chunks/PageLayout_BZPM_SAQ.mjs';
import { $ as $$HeroText } from '../chunks/HeroText_6yVMrHWr.mjs';
import { $ as $$Pricing$1 } from '../chunks/Pricing_B9kdnjiZ.mjs';
...
const $$Pricing = createComponent(($$result, $$props, $$slots) => {
  const metadata = {
    title: "Pricing \u2014 IPTV Smarters Pro Plans | Affordable IPTV Subscription",
    description: "IPTV Smarters Pro pricing plans - Choose from 1 Month ($20), 12 Months ($60) plans. One-time payment for 15,000+ Live TV channels, 50,000+ movies & TV shows. Premium IPTV subscription with EPG support.",
    keywords: pageKeywords.pricing.join(", ")
  };
  return renderTemplate`${renderComponent($$result, "Layout", $$PageLayout, { "metadata": metadata }, { "default": ($$result2) => renderTemplate`  ${renderComponent($$result2, "HeroText", $$HeroText, { "tagline": "Pricing", "title": "IPTV Smarters Pro Pricing Plans", "subtitle": "Choose the perfect plan for unlimited entertainment. One-time payment for seamless streaming." })}  ${renderComponent($$result2, "Prices", $$Pricing$1, { "title": "Iptv Smarters Pro Pricing Plans", "subtitle": "One time payment", "prices": pricingPlans })}  ${renderComponent($$result2, "Features3", $$Features3, { "title": "Price-related features", "subtitle": "Discover the advantages of choosing our plans", "columns": 2, "items": [
    {
...
}, "/home/zerobug/website/itvsmarterscx/src/pages/pricing.astro", void 0);

const $$file = "/home/zerobug/website/itvsmarterscx/src/pages/pricing.astro";
const $$url = "/pricing";
